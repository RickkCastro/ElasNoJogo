        ...
        >
            <div className="relative h-full w-full mx-auto max-w-none md:max-w-[640px] lg:max-w-[720px]">
                ...
                <video
                    ...
                    onLoadedMetadata={(e) =>
                        onLoadedMetadata(index, e.currentTarget)
                    }
                ...
                <div className="pointer-events-none absolute inset-x-0 bottom-0 h-60 md:h-32 bg-gradient-to-t from-black/80 via-black/40 to-transparent" />

                {/* Overlay de informações do vídeo */}
                <div className="absolute left-0 right-16 md:right-20 lg:right-24 px-4 text-left bottom-24 md:bottom-6 z-10">
                    <Link
                        to={`/perfil/${video.user.id}`}
                        title="Ver perfil"
                    ...
                    {video.location && (
                        <div className="flex gap-1">
                            <CiLocationOn className="min-h-3 min-w-3" />
                            <span className="text-white/80 font-semibold mb-1 text-xs line-clamp-2">
                                {video.location}
                            </span>
                        </div>
                    )}
